...
MIL : {bgcolor : "rgba(255,197,47,0.5)", hrcolor : "rgb(18,40,75)", logo : "<img src='https://mmmccormack.github.io/fantasy-baseball/assets/MIL.SVG' />"},
...
KC : {bgcolor : "rgba(0,70,135,0.5)", hrcolor : "rgb(189,155,96)", logo : "<img src=./assets/KC.SVG />"},
HOU : {bgcolor : "rgba(0,45,98,0.5)", hrcolor : "rgb(244,145,30)", logo : "<img src=./assets/HOU.SVG />"},
COL : {bgcolor : "rgba(51,0,111,0.5)", hrcolor : "rgb(0,0,0)", logo : "<img src=./assets/COL.SVG />"},
CLE : {bgcolor : "rgba(12,35,64,0.5)", hrcolor : "rgb(227,25,55)", logo : "<img src=./assets/CLE.SVG />"},
CHW : {bgcolor : "rgba(196,206,212,0.5)", hrcolor : "rgb(39,37,31)", logo : "<img src=./assets/CHW.SVG />"},
CHC : {bgcolor : "rgba(14,51,134,0.5)", hrcolor : "rgb(204,52,51)", logo : "<img src=./assets/CHC.SVG />"},
BOS : {bgcolor : "rgba(189, 48, 57,0.5)", hrcolor : "rgb(12,35,64)", logo : "<img src=./assets/BOS.SVG />"},
BAL : {bgcolor : "rgba(223,70,1,0.5)", hrcolor : "rgb(39,37,31)", logo : "<img src=./assets/BAL.SVG />"},
ATL : {bgcolor : "rgba(19,39,79,0.5)", hrcolor : "rgb(206,17,65)", logo : "<img src=./assets/ATL.SVG />"},
ARI : {bgcolor : "rgba(227,212,173,0.6)", hrcolor : "rgb(167,25,48)", logo : "<img src=./assets/ARI.SVG />"},
WSH : {bgcolor : "rgba(20,34,90,0.5)", hrcolor : "rgb(171,0,3)", logo : "<img src=./assets/WSH.SVG />"},
TOR : {bgcolor : "rgba(19,74,142,0.5)", hrcolor : "rgb(255,255,255)", logo : "<img src=./assets/TOR.SVG />"},
TEX : {bgcolor : "rgba(0,50,120,0.5)", hrcolor : "rgb(192,17,31)", logo : "<img src=./assets/TEX.SVG />"},
TB : {bgcolor : "rgba(143,188,230,0.5)", hrcolor : "rgb(9,44,92)", logo : "<img src=./assets/TB.SVG />"},
STL : {bgcolor : "rgba(196,30,58, 0.5)", hrcolor : "rgb(12,35,64)", logo : "<img src=./assets/STL.SVG />"},
SF : {bgcolor : "rgba(253,90,30,0.5)", hrcolor : "rgb(39,37,31)", logo : "<img src=./assets/SF.SVG />"},
SD : {bgcolor : "rgba(47,36,29,0.6)", hrcolor : "rgb(255,196,37)", logo : "<img src=./assets/SD.SVG />"},
PIT : {bgcolor : "rgba(253,184,39,0.5)", hrcolor : "rgb(39,37,31)", logo : "<img src=./assets/PIT.SVG />"},
PHI : {bgcolor : "rgba(111,38,61,0.5)", hrcolor : "rgb(107,172,228)", logo : "<img src=./assets/PHI.SVG />"},
OAK : {bgcolor : "rgba(0,56,49,0.5)", hrcolor : "rgb(239,178,30)", logo : "<img src=./assets/OAK.SVG />"},
NYY : {bgcolor : "rgba(12,35,64,0.5)", hrcolor : "rgb(255,255,255)", logo : "<img src=./assets/NYY.SVG />"},
NYM : {bgcolor : "rgba(0,45, 114,0.5)", hrcolor : "rgb(252,89,16)", logo : "<img src=./assets/NYM.SVG />"},
MIN : {bgcolor : "rgba(0,43,92,0.5)", hrcolor : "rgb(211,17,69)", logo : "<img src=./assets/MIN.SVG />"},
SEA : {bgcolor : "rgba(0,92,92,0.5)", hrcolor : "rgb(12,44,86)", logo : "<img src=./assets/SEA.SVG />"},
CIN : {bgcolor : "rgba(198,1,31,0.5)", hrcolor : "rgb(0,0,0)", logo : "<img src=./assets/CIN.SVG />"},
}
